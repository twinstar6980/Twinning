		...
		inline auto const data = MethodInvokeCommandConfigGroup{
			...
			.child = {
				...
				},
				{
					...
					.type = false,
					.rule = std::nullopt,
					.method = L"data.encrypt.xor.crypt",
					.argument = LR"({})",
				},
				{
					.name = L"Rijndael 加密",
			...
			.child = {
				{
					...
					.method = L"wwise.sound_bank.pack",
					.argument = LR"({})",
				},
				{
					.name = L"解包",
					...
					.method = L"wwise.sound_bank.unpack",
					.argument = LR"({})",
				},
				{
					.name = L"[批处理] 打包",
					.type = true,
					.rule = std::nullopt,
					.method = L"wwise.sound_bank.pack.batch",
					.argument = LR"({})",
				},
				{
					.name = L"[批处理] 解包",
					.type = true,
					.rule = std::nullopt,
					.method = L"wwise.sound_bank.unpack.batch",
					.argument = LR"({})",
				},
			},
			.separator = {
