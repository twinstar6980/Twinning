...
namespace TwinStar::WindowsExplorerExtension::Language {
	...
	inline auto const g_table = std::unordered_map<std::wstring, std::unordered_map<std::wstring, std::wstring>>{
		{L"Chinese", {
			...
			{L"method:popcap.texture.encode:abgr_8888", L"编码 ~ abgr_8888"},
			{L"method:popcap.texture.decode:abgr_8888", L"解码 ~ abgr_8888"},
		...
		{L"English", {
			...
			{L"method:popcap.texture.encode:abgr_8888", L"Encode ~ abgr_8888"},
			{L"method:popcap.texture.decode:abgr_8888", L"Decode ~ abgr_8888"},
