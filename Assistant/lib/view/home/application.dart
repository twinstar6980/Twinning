        ...
        builder: (context, setting, _) => DynamicColorBuilder(
          builder: (lightColor, darkColor) => MaterialApp(
            ...
            theme: ThemeData(
              ...
              scaffoldBackgroundColor: setting.data.mThemeColorState ? null : lightColor?.background,
              fontFamily: '',
            ...
            darkTheme: ThemeData(
              ...
              scaffoldBackgroundColor: setting.data.mThemeColorState ? null : darkColor?.background,
              fontFamily: '',
              fontFamilyFallback: [...setting.state.mThemeFontFamliy],
            ),
