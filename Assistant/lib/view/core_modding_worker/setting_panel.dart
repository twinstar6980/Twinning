                  ...
                  StyledIconButton.standard(
                    ...
                    onPressed: (context) async {
                      var target = await pickStorageItem(
                        context: context,
                        allowLoadFile: true,
                        location: '@${ModuleType.core_modding_worker.name}.kernel',
                      );
                      if (target != null) {
                  ...
                  StyledIconButton.standard(
                    ...
                    onPressed: (context) async {
                      var target = await pickStorageItem(
                        context: context,
                        allowLoadFile: true,
                        location: '@${ModuleType.core_modding_worker.name}.script',
                      );
                      if (target != null) {
                  ...
                  StyledIconButton.standard(
                    ...
                    onPressed: (context) async {
                      var target = await pickStorageItem(
                        ...
                        allowSaveFile: true,
                        location: '@${ModuleType.core_modding_worker.name}.argument',
                      );
                      if (target != null) {
                  ...
                  StyledIconButton.standard(
                    ...
                    onPressed: (context) async {
                      var target = await pickStorageItem(
                        context: context,
                        allowLoadFile: true,
                        location: '@${ModuleType.core_modding_worker.name}.message_font',
                      );
                      if (target != null) {
