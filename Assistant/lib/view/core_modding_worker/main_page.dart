...
import '/view/core_modding_worker/setting.dart';
import '/view/core_modding_worker/configuration.dart';
import '/view/core_modding_worker/message_type.dart';
import '/view/core_modding_worker/message_card.dart';
import '/view/core_modding_worker/submission_type.dart';
import '/view/core_modding_worker/submission_bar.dart';
import '/view/core_modding_worker/value_expression.dart';
import 'dart:async';
...
class _MainPageState extends State<MainPage> implements ModulePageState {
  ...
  Future<ValueExpression?> _receiveSubmission(
    ...
    var history = setting.state.coreModdingWorkerSubmissionHistory[type.index];
...
TextStyle getSpecialFontTextStyle(
  ...
  return TextStyle(inherit: true).copyWith(
    fontFamily: '',
    fontFamilyFallback: [...setting.state.coreModdingWorkerMessageFontFamily, ...setting.state.themeFontFamliy],
  );
}
