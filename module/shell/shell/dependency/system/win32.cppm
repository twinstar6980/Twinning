...
export module twinning.shell.dependency.system.win32;

#if defined M_system_windows

export namespace Twinning::Shell::Dependency::system::win32 {
	...
	inline auto const $SetConsoleMode = SetConsoleMode;
	...
	inline constexpr auto $ENABLE_VIRTUAL_TERMINAL_INPUT = ENABLE_VIRTUAL_TERMINAL_INPUT;

	inline constexpr auto $ENABLE_VIRTUAL_TERMINAL_PROCESSING = ENABLE_VIRTUAL_TERMINAL_PROCESSING;
