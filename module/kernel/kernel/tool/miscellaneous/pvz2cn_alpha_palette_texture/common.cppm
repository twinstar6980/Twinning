...
export module twinning.kernel.tool.miscellaneous.pvz2cn_alpha_palette_texture.common;
...
export namespace Twinning::Kernel::Tool::Miscellaneous::Pvz2cnAlphaPaletteTexture {
	...
	struct Common {
		...
		inline static auto test_palette(
			...
			auto maximum_value = cast_box<Image::Color>(0b1_iu8 << k_maximum_bit_count);
