	...
	struct Decode :
		...
		inline static auto process_image(
			...
			if (compress_texture_data) {
				...
				Data::Compression::Deflate::Uncompress::process(texture_data_stream, ripe_texture_data_stream, 15_i, Data::Compression::Deflate::WrapperType::Constant::zlib());
