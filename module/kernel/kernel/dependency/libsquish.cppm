...
#include "dependency/libsquish/lib/include/squish/squish.h"

#pragma clang diagnostic pop

export module twinning.kernel.dependency.libsquish;

export namespace Twinning::Kernel::Dependency::libsquish {
