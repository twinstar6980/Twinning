...
namespace Twinning.AssistantPlus.View.CoreModdingWorker {
	...
	public partial class SubmissionBarController : CustomController {
		...
		public async void uHistory_Click (
			...
			var font = this.View.FindResource("CoreModdingWorker.MessageFont").As<FontFamily>();
		...
		public async void uPathPickMenu_Click (
			...
			var value = await StorageHelper.Pick(senders.Tag.As<String>(), App.MainWindow, $"@{nameof(CoreModdingWorker)}.Generic", null);
			if (value != null) {
