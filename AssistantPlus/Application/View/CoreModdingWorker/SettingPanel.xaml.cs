...
namespace Twinning.AssistantPlus.View.CoreModdingWorker {
	...
	public partial class SettingPanelController : CustomController {
		...
		public async void uKernelPick_Click (
			...
			var value = await StorageHelper.PickLoadFile(App.MainWindow, $"@{nameof(CoreModdingWorker)}.Kernel");
			if (value != null) {
		...
		public async void uScriptPick_Click (
			...
			var senders = sender.As<Button>();
			var value = await StorageHelper.PickLoadFile(App.MainWindow, $"@{nameof(CoreModdingWorker)}.Script");
			if (value != null) {
		...
		public async void uArgumentPick_Click (
			...
			var value = await StorageHelper.Pick(senders.Tag.As<String>(), App.MainWindow, $"@{nameof(CoreModdingWorker)}.Argument", null);
			if (value != null) {
