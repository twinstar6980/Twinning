...
namespace TwinStar::ForwarderForWindows::Language {
	...
	inline auto const g_table = std::unordered_map<std::wstring, std::unordered_map<std::wstring, std::wstring>>{
		{L"Chinese", {
			...
			{L"forward:texture", L"Texture"},
			{L"forward:texture.transformation.flip", L"翻转"},
			{L"forward:texture.transformation.scale", L"缩放"},
			{L"forward:texture.transformation.scale_rate", L"比例缩放"},
			{L"forward:texture.atlas.pack", L"图集打包"},
			{L"forward:texture.atlas.unpack", L"图集解包"},
			{L"forward:texture.atlas.pack_automatic", L"图集自动打包"},
			...
			{L"forward:popcap.particle_effect", L"PopCap Particle-Effect"},
			{L"forward:popcap.particle_effect.encode", L"编码"},
			{L"forward:popcap.particle_effect.decode", L"解码"},
			{L"forward:popcap.particle_effect.encode.batch", L"[批处理] 编码"},
			{L"forward:popcap.particle_effect.decode.batch", L"[批处理] 解码"},
			{L"forward:popcap.render_effect", L"PopCap Render-Effect"},
			{L"forward:popcap.render_effect.encode", L"编码"},
			{L"forward:popcap.render_effect.decode", L"解码"},
			{L"forward:popcap.render_effect.encode.batch", L"[批处理] 编码"},
			{L"forward:popcap.render_effect.decode.batch", L"[批处理] 解码"},
		...
		{L"English", {
			...
			{L"forward:texture", L"Texture"},
			{L"forward:texture.transformation.flip", L"Flip"},
			{L"forward:texture.transformation.scale", L"Scale"},
			{L"forward:texture.transformation.scale_rate", L"Scale by rate"},
			{L"forward:texture.atlas.pack", L"Atlas Pack"},
			{L"forward:texture.atlas.unpack", L"Atlas Unpack"},
			{L"forward:texture.atlas.pack_automatic", L"Atlas Pack by automatic"},
			{L"forward:wwise.media", L"Wwise Media"},
			...
			{L"forward:popcap.particle_effect", L"PopCap Particle-Effect"},
			{L"forward:popcap.particle_effect.encode", L"Encode"},
			{L"forward:popcap.particle_effect.decode", L"Decode"},
			{L"forward:popcap.particle_effect.encode.batch", L"[BATCH] Encode"},
			{L"forward:popcap.particle_effect.decode.batch", L"[BATCH] Decode"},
			{L"forward:popcap.render_effect", L"PopCap Render-Effect"},
			{L"forward:popcap.render_effect.encode", L"Encode"},
			{L"forward:popcap.render_effect.decode", L"Decode"},
			{L"forward:popcap.render_effect.encode.batch", L"[BATCH] Encode"},
			{L"forward:popcap.render_effect.decode.batch", L"[BATCH] Decode"},
			{L"forward:popcap.character_font_widget_2", L"PopCap Character-Font-Widget-2"},
