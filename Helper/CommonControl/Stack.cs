...
namespace Helper.CommonControl {
	...
	public class Stack : Panel {
		...
		public static readonly DependencyProperty OrientationProperty = DependencyProperty.Register(
			...
			typeof(Orientation),
			typeof(Stack),
			new PropertyMetadata(Orientation.Horizontal, (o, e) => { o.AsClass<Stack>().InvalidateMeasure(); })
		);
		...
		public static readonly DependencyProperty SpacingProperty = DependencyProperty.Register(
			...
			typeof(Floater),
			typeof(Stack),
			new PropertyMetadata(0.0, (o, e) => { o.AsClass<Stack>().InvalidateMeasure(); })
		);
		...
		public static readonly DependencyProperty WeightProperty = DependencyProperty.RegisterAttached(
			...
			typeof(Floater),
			typeof(Stack),
			new PropertyMetadata(Floater.NaN, (o, e) => { o.AsClass<FrameworkElement>().Parent.AsClassOrNull<Stack>()?.InvalidateMeasure(); })
		);
