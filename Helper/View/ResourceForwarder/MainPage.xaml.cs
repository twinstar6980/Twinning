...
namespace Helper.View.ResourceForwarder {
	...
	public class MainPageController : CustomController {
		...
		public void Initialize (
			...
			try {
				optionConfiguration = JsonHelper.DeserializeText<List<OptionGroupConfiguration>>(StorageHelper.ReadFileTextSync(Setting.Data.ResourceForwarder.OptionConfiguration));
			}
			catch (Exception e) {
