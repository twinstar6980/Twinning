...
namespace Helper.View.CommandSender {
	...
	public class MainPageController : CustomController {
		...
		public void Initialize (
			...
			try {
				methodConfiguration = JsonHelper.DeserializeText<List<MethodGroupConfiguration>>(StorageHelper.ReadFileTextSync(Setting.Data.CommandSender.MethodConfiguration));
			}
			catch (Exception e) {
