...
namespace Helper.Module.PackageBuilder {
	...
	public sealed partial class PackagePartPanel : CustomControl {
		...
		public PackagePartPanel (
			...
			this.Controller = new PackagePartPanelController() { View = this };
		}
	...
	public class PackagePartPanelController : CustomController {
		...
		public List<PackagePartPanelItemController> uList_ItemsSource { get; set; } = new List<PackagePartPanelItemController>();
