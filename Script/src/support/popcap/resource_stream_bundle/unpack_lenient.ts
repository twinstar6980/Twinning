	...
	function unpack_resource(
		...
		if (size === null) {
			...
			if (size !== 0) {
				...
				Kernel.Tool.Data.Compression.Deflate.Uncompress.process(raw_stream, ripe_stream, Kernel.Integer.value(15n), Kernel.Tool.Data.Compression.Deflate.Wrapper.value('zlib'));
			}
		}
