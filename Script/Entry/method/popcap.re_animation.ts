		...
		g_executor_method.push(
			Executor.method_of({
				...
				worker(a: Entry.CFSA & {
					...
					CoreX.Tool.PopCap.ReAnimation.encode_fs(data_file, manifest_file, { platform: version_platform, variant_64: version_variant_64 }, buffer_size);
			...
			Executor.method_of({
				...
				worker(a: Entry.CFSA & {
					...
					CoreX.Tool.PopCap.ReAnimation.decode_fs(data_file, manifest_file, { platform: version_platform, variant_64: version_variant_64 });
				...
				worker(a: Entry.CFSA & {
					...
					simple_batch_execute(
						...
						(item) => {
							...
							CoreX.Tool.PopCap.ReAnimation.encode_fs(data_file, manifest_file, { platform: version_platform, variant_64: version_variant_64 }, data_buffer.view());
						},
					);
