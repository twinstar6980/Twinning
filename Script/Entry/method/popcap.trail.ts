		...
		g_executor_method.push(
			Executor.method_of({
				...
				worker(a: Entry.CommonArgument & {
					...
					CoreX.Tool.PopCap.Trail.encode_fs(data_file, definition_file, { platform: version_platform as any, variant_64: version_variant_64 }, buffer_size);
					return [`${data_file}`];
				},
				default_argument: {
			...
			Executor.method_of({
				...
				worker(a: Entry.CommonArgument & {
					...
					CoreX.Tool.PopCap.Trail.decode_fs(data_file, definition_file, { platform: version_platform as any, variant_64: version_variant_64 });
				...
				worker(a: Entry.CommonArgument & {
					...
					simple_batch_execute(
						...
						(item) => {
							...
							CoreX.Tool.PopCap.Trail.encode_fs(data_file, definition_file, { platform: version_platform as any, variant_64: version_variant_64 }, data_buffer.view());
						},
					);
