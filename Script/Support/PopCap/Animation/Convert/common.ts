namespace TwinStar.Script.Support.PopCap.Animation.Convert {
	...
	export function compute_standard_transform_from_variant(
		transform: Core.Tool.PopCap.Animation.Manifest.JS_N.VariantTransform,
	): Transform {
	...
	export function compute_variant_transform_from_standard(
		data: Transform,
	): Core.Tool.PopCap.Animation.Manifest.JS_N.VariantTransform {
