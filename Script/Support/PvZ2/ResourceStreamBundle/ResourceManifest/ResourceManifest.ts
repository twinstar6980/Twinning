namespace TwinStar.Script.Support.PvZ2.ResourceStreamBundle.ResourceManifest {
	...
	export type Subgroup = {
		...
		//resource_data_sectionn_store_mode: Core.Tool.PopCap.ResourceStreamBundle.Manifest.JS_N.ResourceDataSectionStoreMode;
	};
