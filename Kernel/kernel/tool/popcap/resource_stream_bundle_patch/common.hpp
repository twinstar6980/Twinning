...
#include "kernel/tool/popcap/resource_stream_bundle_patch/version.hpp"
...
namespace Twinning::Kernel::Tool::PopCap::ResourceStreamBundlePatch {
	...
	struct Common {
		...
		static auto read_package_information_structure (
			...
			data.read_constant(cbw<ResourceStreamBundle::Structure::VersionNumber>(package_version.number));
			data.read(information_structure.header);
			assert_test(cbw<Size>(information_structure.header.group_information_section_block_size) == bs_static_size<ResourceStreamBundle::Structure::GroupInformation<package_version>>());
			...
			assert_test(cbw<Size>(information_structure.header.pool_information_section_block_size) == bs_static_size<ResourceStreamBundle::Structure::PoolInformation<package_version>>());
		...
		static auto compress_packet (
			...
			raw.read_constant(cbw<ResourceStreamGroup::Structure::VersionNumber>(packet_version.number));
		...
		static auto uncompress_packet (
			...
			ripe.read_constant(cbw<ResourceStreamGroup::Structure::VersionNumber>(packet_version.number));
			auto information_structure = ResourceStreamGroup::Structure::Information<packet_version>{};
			{
