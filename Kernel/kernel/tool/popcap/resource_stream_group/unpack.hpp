			...
			for (auto & current_resource_type : make_static_array<ResourceType>(ResourceType::Constant::general(), ResourceType::Constant::texture())) {
				...
				switch (current_resource_type.value) {
					case ResourceType::Constant::general().value : {
						resource_data_section_offset = cbw<Size>(information_structure.header.general_resource_data_section_offset);
						resource_data_section_size = cbw<Size>(information_structure.header.general_resource_data_section_size);
						resource_data_section_size_original = cbw<Size>(information_structure.header.general_resource_data_section_size_original);
