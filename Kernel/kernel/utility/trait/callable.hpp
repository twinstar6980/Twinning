...
namespace TwinStar::Kernel::Trait {
	...
	#if defined M_compiler_msvc // TODO : avoid msvc bug : in msvc 19.34~36, pass global function pointer to non-type template argument will auto cast to function object, such as R (*) (A...) -> R (A...)
	template <typename TResult, typename ... TArgument> requires
		AutoConstraint
