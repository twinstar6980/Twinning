...
#include "kernel/tool/data/hash/fnv/hash.hpp"
#include "kernel/tool/data/hash/md5/hash.hpp"
#include "kernel/tool/data/encoding/base64/encode.hpp"
#include "kernel/tool/data/encoding/base64/decode.hpp"
#include "kernel/tool/data/encryption/xor/encrypt.hpp"
#include "kernel/tool/data/encryption/rijndael/encrypt.hpp"
#include "kernel/tool/data/encryption/rijndael/decrypt.hpp"
...
#include "kernel/tool/data/compression/bzip2/uncompress.hpp"
#include "kernel/tool/data/compression/lzma/compress.hpp"
#include "kernel/tool/data/compression/lzma/uncompress.hpp"
#include "kernel/tool/data/differentiation/vcdiff/encode.hpp"
#include "kernel/tool/data/differentiation/vcdiff/decode.hpp"
#include "kernel/tool/data/serialization/json/write.hpp"
#include "kernel/tool/data/serialization/json/read.hpp"
#include "kernel/tool/data/serialization/xml/write.hpp"
#include "kernel/tool/data/serialization/xml/read.hpp"
#include "kernel/tool/texture/transformation/flip.hpp"
...
#include "kernel/tool/marmalade/dzip/unpack.hpp"
#include "kernel/tool/popcap/zlib/compress.hpp"
#include "kernel/tool/popcap/zlib/uncompress.hpp"
#include "kernel/tool/popcap/crypt_data/encrypt.hpp"
#include "kernel/tool/popcap/crypt_data/decrypt.hpp"
#include "kernel/tool/popcap/reflection_object_notation/encode.hpp"
#include "kernel/tool/popcap/reflection_object_notation/decode.hpp"
#include "kernel/tool/popcap/u_texture/encode.hpp"
#include "kernel/tool/popcap/u_texture/decode.hpp"
#include "kernel/tool/popcap/sexy_texture/encode.hpp"
#include "kernel/tool/popcap/sexy_texture/decode.hpp"
#include "kernel/tool/popcap/animation/encode.hpp"
#include "kernel/tool/popcap/animation/decode.hpp"
#include "kernel/tool/popcap/re_animation/encode.hpp"
#include "kernel/tool/popcap/re_animation/decode.hpp"
#include "kernel/tool/popcap/particle/encode.hpp"
#include "kernel/tool/popcap/particle/decode.hpp"
#include "kernel/tool/popcap/trail/encode.hpp"
#include "kernel/tool/popcap/trail/decode.hpp"
#include "kernel/tool/popcap/render_effect/encode.hpp"
#include "kernel/tool/popcap/render_effect/decode.hpp"
#include "kernel/tool/popcap/particle_effect/encode.hpp"
#include "kernel/tool/popcap/particle_effect/decode.hpp"
#include "kernel/tool/popcap/character_font_widget_2/encode.hpp"
#include "kernel/tool/popcap/character_font_widget_2/decode.hpp"
#include "kernel/tool/popcap/package/pack.hpp"
#include "kernel/tool/popcap/package/unpack.hpp"
#include "kernel/tool/popcap/resource_stream_group/pack.hpp"
#include "kernel/tool/popcap/resource_stream_group/unpack.hpp"
#include "kernel/tool/popcap/resource_stream_bundle/pack.hpp"
#include "kernel/tool/popcap/resource_stream_bundle/unpack.hpp"
#include "kernel/tool/popcap/resource_stream_bundle_patch/encode.hpp"
#include "kernel/tool/popcap/resource_stream_bundle_patch/decode.hpp"
#include "kernel/tool/miscellaneous/xbox_tiled_texture/encode.hpp"
#include "kernel/tool/miscellaneous/xbox_tiled_texture/decode.hpp"
#include "kernel/tool/miscellaneous/pvz2_cn_alpha_palette_texture/encode.hpp"
#include "kernel/tool/miscellaneous/pvz2_cn_alpha_palette_texture/decode.hpp"
...
namespace TwinStar::Kernel::Executor::Interface {
	...
	inline auto inject (
		...
		// FileSystem
		{
			...
			s_FileSystem
				// exist
				.add_function_proxy<&stpg<&FileSystem::exist>>("exist"_s)
				.add_function_proxy<&stpg<&FileSystem::exist_file>>("exist_file"_s)
				.add_function_proxy<&stpg<&FileSystem::exist_directory>>("exist_directory"_s)
				// generic
				.add_function_proxy<&stpg<&FileSystem::copy>>("copy"_s)
				.add_function_proxy<&stpg<&FileSystem::rename>>("rename"_s)
				.add_function_proxy<&stpg<&FileSystem::remove>>("remove"_s)
				// link
				.add_function_proxy<&stpg<&FileSystem::create_link>>("create_link"_s)
				.add_function_proxy<&stpg<&FileSystem::parse_link>>("parse_link"_s)
				// hard link
				.add_function_proxy<&stpg<&FileSystem::create_hard_link>>("create_hard_link"_s)
				// file
				.add_function_proxy<&stpg<&FileSystem::create_file>>("create_file"_s)
				.add_function_proxy<&stpg<&FileSystem::size_file>>("size_file"_s)
				.add_function_proxy<&stpg<&FileSystem::resize_file>>("resize_file"_s)
				.add_function_proxy<&stpg<&FileSystem::read_file>>("read_file"_s)
				.add_function_proxy<&stpg<&FileSystem::write_file>>("write_file"_s)
				.add_function_proxy<&stpg<&FileSystem::read_stream_file>>("read_stream_file"_s)
				.add_function_proxy<&stpg<&FileSystem::write_stream_file>>("write_stream_file"_s)
				// directory
				.add_function_proxy<&stpg<&FileSystem::create_directory>>("create_directory"_s)
				// iterate
				.add_function_proxy<&stpg<&FileSystem::count>>("count"_s)
				.add_function_proxy<&stpg<&FileSystem::count_file>>("count_file"_s)
				.add_function_proxy<&stpg<&FileSystem::count_directory>>("count_directory"_s)
				.add_function_proxy<&stpg<&FileSystem::list>>("list"_s)
				.add_function_proxy<&stpg<&FileSystem::list_file>>("list_file"_s)
				.add_function_proxy<&stpg<&FileSystem::list_directory>>("list_directory"_s);
		}
		// Process
		{
				...
				}
				{
					auto s_Encryption = s_Data.add_space("Encryption"_s);
					{
						...
						s_XOR.add_space("Encrypt"_s)
							.add_function_proxy<&stpg<&Tool::Data::Encryption::XOR::Encrypt::process>>("process"_s);
					}
					{
						...
						.add_function_proxy<&stpg<&normalized_lambda<
							...
							Version const &                 version
								...
								Generalization::match<VersionPackage>(
									version,
									[&] <auto index, auto version> (ValuePackage<index>, ValuePackage<version>) {
										Tool::PopCap::ResourceStreamBundle::Pack<version>::process(data, definition.template get_of_index<mbw<Size>(index)>(), manifest.template get_of_index<mbw<Size>(index)>(), resource_directory, packet_file, new_packet_file);
									}
								);
							}
						>>>("process"_s);
						...
						.add_function_proxy<&stpg<&normalized_lambda<
							...
							Version const &           version
								...
								Generalization::match<VersionPackage>(
									version,
									[&] <auto index, auto version> (ValuePackage<index>, ValuePackage<version>) {
										Tool::PopCap::ResourceStreamBundle::Unpack<version>::process(data, definition.template set_of_index<mbw<Size>(index)>(), manifest.template set_of_index<mbw<Size>(index)>(), resource_directory, packet_file);
									}
								);
							}
						>>>("process"_s);
		...
		// Miscellaneous
		{
			...
			define_generic_class<Thread, GCDF::default_constructor>(s_Miscellaneous, "Thread"_s)
				.add_member_function_proxy<&stpm<Thread, &Thread::joinable>>("joinable"_s)
				.add_member_function_proxy<&stpm<Thread, &Thread::join>>("join"_s)
				.add_member_function_proxy<&stpm<Thread, &Thread::detach>>("detach"_s)
				.add_static_function_proxy<&stpg<&Thread::yield>>("yield"_s)
				.add_static_function_proxy<&stpg<&Thread::sleep>>("sleep"_s);
