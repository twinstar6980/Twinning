...
#include "dependency/astc_encoder/Source/astcenc.h"

#pragma clang diagnostic pop

export module twinning.kernel.dependency.astc_encoder;

export namespace Twinning::Kernel::Dependency::astc_encoder {
